...
namespace Texell.CandyCoolSummer
{
    ...
    public class Board : MonoBehaviour
    {
        ...
        /// <summary>
        /// Dictionary obstacle (key: cell position, value: obstacle object).
        /// Store all obstacles on the board.
        /// </summary>
        private Dictionary<Vector3Int, Obstacle> _DicObstacles = new();
        private Grid _grid;
        ...
        public static void RegisterCandy(Vector3Int cellPos, Candy candyPrefab)
        {
            ...
            if (candyPrefab != null)
            {
                var candy = CandyFactory.Create(candyPrefab);
                candy.transform.position = s_Instance._grid.GetCellCenterWorld(cellPos);
        ...
        void SpawnCandyRandom()
        {
            ...
            {
                var listTypes = _candyLookup.Keys.ToList();
                ...
                var candy = CandyFactory.Create(_candyLookup[type]);
