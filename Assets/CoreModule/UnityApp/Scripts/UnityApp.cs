...
namespace Texell.CoreModule.Application
{
    ...
    using Texell.CoreModule.FPS;
    using Texell.CoreModule.AppData;
    using Texell.CoreModule.AssetManagement;
    using Texell.CoreModule.ProcessManager;
    using Texell.CoreModule.Audio;
    using Texell.CoreModule.Input;
